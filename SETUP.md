These instructions will help you to set up your development environment, get the source code of the Loopin for Android app and build it by yourself. If you want to help developing the app take a look to the [contribution guidelines][0].
...
### 1. Fork and download the LoopinCloud/android-client repository.

You will need [git][1] to access to the different versions of the Loopin's source code. The source code is hosted in Github and may be read by anybody without needing a Github account. You will need a Github account if you want to contribute to the development of the app with your own code.

Next steps will assume you have a Github account and that you will get the code from your own fork.

* In a web browser, go to https://github.com/LoopinCloud/android-client, and click the 'Fork' button near the top right corner.
...
* Make official Loopin repo known as upstream: ```git remote add upstream git@github.com:LoopinCloud/android-client.git```
...
* generic - the regular build, released as a Nextcloud/Loopin Android app on the Play store
...
[0]: https://github.com/LoopinCloud/android-client/blob/master/CONTRIBUTING.md
[1]: https://git-scm.com/
